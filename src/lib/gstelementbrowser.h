...
public:
	...
	QStringList elementNames() const { return m_elementNames; }
	QString selectedElement() const { return m_selectedElement; }
	QString elementDescription() const { return m_currentElement.description; }
	QString elementClassification() const { return m_currentElement.classification; }
	QString elementAuthor() const { return m_currentElement.author; }
	GstPropertyModel* propertyModel() { return m_propertyModel; }
	GstPadModel* padModel() { return m_padModel; }
